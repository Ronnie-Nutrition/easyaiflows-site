  ...
  },
  {
    ...
    deepDive: {
      ...
      blocks: [
        ...
        { title: "Why we care about this one", body: "EasyAiFlows is run by Ronnie Craig, an RN who spends his working life in hospice care — so the nonprofit and community-health world is not an industry vertical we picked off a list. We do grant research for several nonprofit organizations, which is how we know what a grant calendar actually costs a small team, and we do 501(c)(3) formation work, so we also see organizations at the very beginning, before any of these systems exist. If you are still at that stage, start there instead: see our <a href=\"/nonprofit\">501(c)(3) formation service</a>." }
      ]
    },
    faqs: [
